<meta charset="utf-8">
      ...
      <!-- Favicon Icon -->
      <link rel="icon" type="{{ asset('theme/assets/image/png') }}" href="img/favicon.png">
      <!-- Bootstrap core CSS-->
      <link href="{{ asset('theme/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
      <!-- Custom fonts for this template-->
      <link href="{{ asset('theme/assets/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
      <!-- Custom styles for this template-->
      <link href="{{ asset('theme/assets/css/osahan.css') }}" rel="stylesheet">
      <!-- Owl Carousel -->
